      ...
      <aside className="w-64 border-r border-slate-200 bg-white flex flex-col justify-between p-6">
        <div className="space-y-8">
          ...
          <div className="flex items-center space-x-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-500/10 border border-amber-500/25 text-amber-600">
          ...
          <nav className="space-y-1.5">
            <Link
              href="/researcher"
              className="flex items-center space-x-3 rounded-lg bg-amber-50 px-3 py-2 text-sm font-semibold text-amber-800 border border-amber-100"
            >
