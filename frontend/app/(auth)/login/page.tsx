    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950 px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="relative w-full max-w-md space-y-8">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-teal-500/10 border border-teal-500/20 text-teal-400 shadow-[0_0_20px_-3px_rgba(20,184,166,0.3)]">
        ...
        {/* Form card */}
        <div className="rounded-2xl border border-slate-800 bg-slate-900/60 backdrop-blur-xl p-8 shadow-2xl shadow-slate-950/50">
          <form className="space-y-6" onSubmit={handleLogin}>
            {error && (
              <div className="flex items-start space-x-3 rounded-lg border border-red-500/20 bg-red-500/5 p-4 text-sm text-red-200">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full rounded-xl border border-slate-800 bg-slate-950/80 py-3 pl-10 pr-4 text-sm text-white placeholder-slate-500 transition-colors focus:border-teal-500 focus:outline-hidden focus:ring-1 focus:ring-teal-500"
            ...
            <button
              type="submit"
              disabled={loading}
              className="group relative flex w-full justify-center rounded-xl bg-gradient-to-r from-teal-500 to-emerald-500 py-3.5 px-4 text-sm font-semibold text-slate-950 shadow-lg shadow-teal-500/20 transition-all hover:brightness-110 active:scale-[0.98] disabled:scale-100 disabled:opacity-50"
            >
              {loading ? (
          ...
          <div className="mt-8 pt-6 border-t border-slate-800/80">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="flex flex-col items-start rounded-lg border border-slate-800 bg-slate-950/50 p-2.5 text-left transition-colors hover:bg-slate-900 hover:border-slate-700"
              >
                <span className="text-xs font-medium text-teal-400">Student</span>
              ...
              <button
                ...
                className="flex flex-col items-start rounded-lg border border-slate-800 bg-slate-950/50 p-2.5 text-left transition-colors hover:bg-slate-900 hover:border-slate-700"
              >
                <span className="text-xs font-medium text-indigo-400">Instructor/TA</span>
              ...
              <button
                ...
                className="flex flex-col items-start rounded-lg border border-slate-800 bg-slate-950/50 p-2.5 text-left transition-colors hover:bg-slate-900 hover:border-slate-700"
              >
                <span className="text-xs font-medium text-amber-400">Researcher</span>
              ...
              <button
                ...
                className="flex flex-col items-start rounded-lg border border-slate-800 bg-slate-950/50 p-2.5 text-left transition-colors hover:bg-slate-900 hover:border-slate-700"
              >
                <span className="text-xs font-medium text-pink-400">Expert Rater</span>
        ...
        <div className="text-center">
          <a
            href="/status"
            className="inline-flex items-center text-xs font-medium text-teal-400/80 hover:text-teal-400 transition-colors"
          >
