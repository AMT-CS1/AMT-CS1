...
export default async function InstructorLayout({
  ...
  const username = decoded?.sub || 'Instructor';
    ...
    <div className="flex min-h-screen bg-slate-950 text-slate-100">
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <span className="text-[10px] font-semibold text-indigo-400 bg-indigo-500/5 px-2 py-0.5 rounded-full border border-indigo-500/10">
                Instructor Console
              </span>
            </div>
          </div>
          ...
          <nav className="space-y-1.5">
            <Link
              href="/instructor"
              className="flex items-center space-x-3 rounded-lg bg-indigo-500/5 px-3 py-2 text-sm font-medium text-indigo-400 border border-indigo-500/10"
            >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 border-b border-slate-900 px-8 flex items-center justify-between bg-slate-900/10">
          <h2 className="text-lg font-bold text-white tracking-wide">Review Console</h2>
